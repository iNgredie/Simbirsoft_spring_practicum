...
class Command(BaseCommand):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.FIRST_NAME_FIELD = getattr(
            self.UserModel, "FIRST_NAME_FIELD", "first_name"
        )
    ...
    def add_arguments(self, parser):
        for field in sorted(self.FIELDS):
            parser.add_argument(
                ...
                % (
                    ...
                    ("required" if field in self.REQUIRED_FIELDS else "optional"),
                ),
            )
        parser.add_argument(
            "--is-staff",
        ...
        parser.add_argument(self.UserModel.USERNAME_FIELD, help="Login; required")
    ...
    def handle(self, *args, **options):
        ...
        if verbosity >= 1:
            self.stdout.write(
                "User %s created successfully." % options[self.USERNAME_FIELD]
            )
